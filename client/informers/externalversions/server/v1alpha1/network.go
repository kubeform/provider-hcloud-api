	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServerV1alpha1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServerV1alpha1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&serverv1alpha1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&serverv1alpha1.Network{}, f.defaultInformer)
}
