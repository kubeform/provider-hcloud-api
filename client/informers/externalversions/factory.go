...
import (
	...
	certificate "kubeform.dev/provider-hcloud-api/client/informers/externalversions/certificate"
	firewall "kubeform.dev/provider-hcloud-api/client/informers/externalversions/firewall"
	floating "kubeform.dev/provider-hcloud-api/client/informers/externalversions/floating"
	internalinterfaces "kubeform.dev/provider-hcloud-api/client/informers/externalversions/internalinterfaces"
	load "kubeform.dev/provider-hcloud-api/client/informers/externalversions/load"
	managed "kubeform.dev/provider-hcloud-api/client/informers/externalversions/managed"
	network "kubeform.dev/provider-hcloud-api/client/informers/externalversions/network"
	rdns "kubeform.dev/provider-hcloud-api/client/informers/externalversions/rdns"
	server "kubeform.dev/provider-hcloud-api/client/informers/externalversions/server"
	snapshot "kubeform.dev/provider-hcloud-api/client/informers/externalversions/snapshot"
	ssh "kubeform.dev/provider-hcloud-api/client/informers/externalversions/ssh"
	uploaded "kubeform.dev/provider-hcloud-api/client/informers/externalversions/uploaded"
	volume "kubeform.dev/provider-hcloud-api/client/informers/externalversions/volume"
...
func (f *sharedInformerFactory) Uploaded() uploaded.Interface {
	return uploaded.New(f, f.namespace, f.tweakListOptions)
}
