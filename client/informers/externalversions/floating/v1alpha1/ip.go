	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FloatingV1alpha1().Ips(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FloatingV1alpha1().Ips(namespace).Watch(context.TODO(), options)
			},
		},
		&floatingv1alpha1.Ip{},
		resyncPeriod,
...
func (f *ipInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&floatingv1alpha1.Ip{}, f.defaultInformer)
}
