...
type Interface interface {
	...
	Ips() IpInformer
	// IpAssignments returns a IpAssignmentInformer.
	IpAssignments() IpAssignmentInformer
}
...
// IpAssignments returns a IpAssignmentInformer.
func (v *version) IpAssignments() IpAssignmentInformer {
	return &ipAssignmentInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
