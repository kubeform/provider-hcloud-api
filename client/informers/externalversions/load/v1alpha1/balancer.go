	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LoadV1alpha1().Balancers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LoadV1alpha1().Balancers(namespace).Watch(context.TODO(), options)
			},
		},
		&loadv1alpha1.Balancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *balancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&loadv1alpha1.Balancer{}, f.defaultInformer)
}
