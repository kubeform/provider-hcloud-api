...
import (
	...
	v1alpha1 "kubeform.dev/provider-hcloud-api/client/listers/uploaded/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UploadedV1alpha1().Certificates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UploadedV1alpha1().Certificates(namespace).Watch(context.TODO(), options)
			},
		},
		&uploadedv1alpha1.Certificate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *certificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&uploadedv1alpha1.Certificate{}, f.defaultInformer)
}
