...
type LoadV1alpha1Interface interface {
	RESTClient() rest.Interface
	BalancersGetter
	BalancerNetworksGetter
	BalancerServicesGetter
	BalancerTargetsGetter
}
...
func NewForConfig(c *rest.Config) (*LoadV1alpha1Client, error) {
	...
	return &LoadV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LoadV1alpha1Client for the given config and
...
func New(c rest.Interface) *LoadV1alpha1Client {
	return &LoadV1alpha1Client{c}
}
