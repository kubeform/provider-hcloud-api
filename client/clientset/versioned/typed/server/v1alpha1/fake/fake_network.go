...
var networksResource = schema.GroupVersionResource{Group: "server.hcloud.kubeform.com", Version: "v1alpha1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "server.hcloud.kubeform.com", Version: "v1alpha1", Kind: "Network"}
