...
var serversResource = schema.GroupVersionResource{Group: "server.hcloud.kubeform.com", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "server.hcloud.kubeform.com", Version: "v1alpha1", Kind: "Server"}
