...
type FakeCertificates struct {
	Fake *FakeUploadedV1alpha1
	ns   string
}

var certificatesResource = schema.GroupVersionResource{Group: "uploaded.hcloud.kubeform.com", Version: "v1alpha1", Resource: "certificates"}

var certificatesKind = schema.GroupVersionKind{Group: "uploaded.hcloud.kubeform.com", Version: "v1alpha1", Kind: "Certificate"}
