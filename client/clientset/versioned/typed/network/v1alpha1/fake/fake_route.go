...
var routesResource = schema.GroupVersionResource{Group: "network.hcloud.kubeform.com", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "network.hcloud.kubeform.com", Version: "v1alpha1", Kind: "Route"}
