...
var subnetsResource = schema.GroupVersionResource{Group: "network.hcloud.kubeform.com", Version: "v1alpha1", Resource: "subnets"}

var subnetsKind = schema.GroupVersionKind{Group: "network.hcloud.kubeform.com", Version: "v1alpha1", Kind: "Subnet"}
